...
|    setwelcometext     | setwelcometext [text]        | Sets the welcome text for the server   |
...
|    embed     | embed [t/d/td] [fields(optional)] [channel(optional)] [img(optional)]        | Makes an embed   |
