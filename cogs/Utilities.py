...
class Utilities(commands.Cog):
    ...
    async def weather(self, ctx, *, city):
        ...
        try:
            ...
            em.add_field(
                name="Min/Max:", value=f"Minimum Temperature today is {min} And the max will be {max}")
        ...
        try:
            ...
            em.add_field(name="Feels Like:",
                         value=f"It feels like {feelslike} degrees celsius")
        except Exception as e:
            print(e)
        ...
        try:
            ...
            em.add_field(name="Temerature:",
                         value=f"The temperature is {temp} degrees celsius")
        except Exception as e:
            print(e)
        ...
        try:
            ...
            em.add_field(name="Description:",
                         value=f"Weather description {main}, {desc}")
        except Exception as e:
            print(e)
